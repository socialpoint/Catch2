 ...
 */
#ifndef TWOBLUECUBES_CATCH_REPORTER_SONARQUBE_HPP_INCLUDED
#define TWOBLUECUBES_CATCH_REPORTER_SONARQUBE_HPP_INCLUDED
    ...
    struct SonarQubeReporter : CumulativeReporterBase<SonarQubeReporter> {
        ...
        void writeAssertion( AssertionStats const& stats, bool okToFail ) {
            ...
            if( !result.isOk() ) {
                ...
                messageRss << result.getTestMacroName() << "(" << result.getExpandedExpression() << ")";
                ...
                xml.writeText( textRss.str(), true );
            }
        }
...
#endif // TWOBLUECUBES_CATCH_REPORTER_SONARQUBE_HPP_INCLUDED
